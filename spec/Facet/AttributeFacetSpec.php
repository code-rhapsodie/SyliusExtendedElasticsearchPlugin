...
namespace spec\CodeRhapsodie\SyliusExtendedElasticsearchPlugin\Facet;

use CodeRhapsodie\SyliusExtendedElasticsearchPlugin\Facet\AttributeFacet;
use CodeRhapsodie\SyliusExtendedElasticsearchPlugin\Facet\FacetInterface;
